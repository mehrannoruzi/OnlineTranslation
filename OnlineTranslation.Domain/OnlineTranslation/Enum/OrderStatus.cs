namespace Rasmi724.Domain.Enum
{
    using Properties;
    ...
    public enum OrderStatus : byte
    {
        ...
        [LocalizeDescription(nameof(DisplayName.WaitForConfirmDraft), typeof(DisplayName))]
        WaitForConfirmDraft = 16,

        [LocalizeDescription(nameof(DisplayName.PayAllPayment), typeof(DisplayName))]
        WaitForAllPayment = 18,
